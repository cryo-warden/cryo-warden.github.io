...
type TypeSubscriptionListenerMap<E extends Event> = {
  ...
  set<T extends Type<E>>(type: T, subscriptionListenerMap: Map<Subscription, Listener<E, T>>): void;
...
export const createEventSystem = <E extends Event>(): EventSystem<E> => {
  const typeSubscriptionListenerMap = new Map() as TypeSubscriptionListenerMap<E>;
